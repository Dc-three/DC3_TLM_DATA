...
csv_file_path2 = './final_TIMESERIES_DATA.csv'
...
if not data2.empty:
        data2.replace({np.nan: None, 'nan': None}, inplace=True)
else:
...
if 'your_datetime_column' in data2.columns:
    data2['your_datetime_column'] = data2['your_datetime_column'].apply(preprocess_datetime) 
...
table_name = 'TimeseriesData'  # Your table name  
